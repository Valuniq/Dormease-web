      ...
      <div className='flex flex-col relative w-[1200px]'>
        ...
        <div className='flex border-t-1 border-t-gray-grayscale50 pt-31 px-46 h-590'>
          <div className='flex-1 flex flex-col pr-170'>
            ...
            />
            <StudentManagement label='등본' isEdit={isEdit} type='file' text='' value={input.certifiedFile} />
            <StudentManagement label='우선선발' isEdit={isEdit} type='file' text='' value={input.prioritySelection} />
            <StudentManagement
              isEdit={isEdit}
              type='string'
              label='식수'
          ...
          <div className='flex-1 flex flex-col'>
            ...
            />
            <StudentManagement right={isEdit} label='상점' text={input.bounsPoint} value={input.bounsPoint} />
            <StudentManagement right={isEdit} label='벌점' text={input.minusPoint} value={input.minusPoint} />
            <StudentManagement
              right={isEdit}
              label='개인정보 동의'
              isEdit={isEdit}
