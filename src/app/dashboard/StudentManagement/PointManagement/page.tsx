...
export const getMovies = async () => {
  const accessToken =
    'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJwaG9uaWw6VVNFUiIsImlzcyI6IkRvcm1lYXNlVmFsdW5pUSIsImlhdCI6MTcxNTk2MDU4NSwiZXhwIjoxNzE1OTYyMzg1fQ.LOJga6gGzgXEwon0wIS7bHZ7rbJ7cNZswsjfn3zgyj0mWKe4unwnfDMRuEVvpW2YLhO8_TqOmhwUPP5sPCPVNQ';
  ...
  return (
    <div className='w-[1250px]'>
      ...
      <Suspense fallback={<h1>loading movie info</h1>}>
        <PointManagementTemplate list={movie} />
      </Suspense>
    </div>
  );
};
