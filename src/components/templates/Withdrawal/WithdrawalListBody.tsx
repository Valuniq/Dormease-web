...
type Props = WithdrawalListResponseDataList & { index: number };

const WithdrawalsListBody: ForwardRefRenderFunction<HTMLTableRowElement, Props> = (
...
export default forwardRef<HTMLTableRowElement, Props>(WithdrawalsListBody);
