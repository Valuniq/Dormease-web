...
const NoticeWriting = forwardRef<HTMLDivElement, Props>(
  (
    {
      title,
      setTitle,
    ...
    return (
      <div ref={ref} className='xxl:w-full xl:w-800 lg:w-700 md:w-600 w-full  ml-[-80px]'>
        <div className='w-full flex items-center justify-between py-15 border-t-1 border-t-gray-grayscale50'>
...
NoticeWriting.displayName = 'NoticeWriting';
