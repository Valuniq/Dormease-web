...
import DepositConfirmationListBody from './DepositConfirmationListBody';
...
const DepositConfirmationList = ({ list, selectedId }: Props) => {
  return (
...
export default DepositConfirmationList;
